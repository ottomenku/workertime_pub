...
{!! Form::open(['url' => MoHandF::url($param['routes']['base'].'/calendarsave/'.$data['worker_id'],$getT), 
...
<!-- tabform menü -->         
    <div class="col-md-6"  >
        <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#sectionC">Havi mentés</a></li>
        </ul>
            ...
            <div id="sectionB" class="tab-pane fade">
                ...
                <div id="sectionC" class="tab-pane fade">
                    ...
                    <div style="padding-top:15px;padding-bottom:15px;" class="row"> 
                            <div class="col-xs-10">     
                                <button type="submit" name="change" value="create_save" class=" btn-primary btn btn-large">
                                <i class="fa fa-save" aria-hidden="true"> Új mentés</i> 
                                </button>
                                <button type="submit" name="change" value="update_save"  class=" btn-primary btn btn-large">
                                        <i class="fa fa-save" aria-hidden="true"> Utolsó frissítése vagy új</i> 
                                </button>
                            </div> 
                    </div> 
                </div>
